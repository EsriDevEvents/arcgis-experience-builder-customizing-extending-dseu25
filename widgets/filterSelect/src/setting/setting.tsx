...
export default function Setting (props: AllWidgetSettingProps<unknown>) {
  ...
  // Save selected FeatureService data source in widget config
  ...
  // Save selected WebMap data source in widget config
  ...
  return <div className='widget-setting-listen-selection-change p-2'>
    {/* DataSource Selector for FeatureLayer */}
    <DataSourceSelector
      ...
      widgetId={props.id}
    />
    {/* Selector for Map Widget we interact. */}
